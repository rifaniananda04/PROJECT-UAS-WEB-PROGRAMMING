...
<head>
  ...
  <title>Sepeda Air Danau Kelapa Gading Admin_page.com</title>
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          ...
          <li class="dropdown"><a href="#kategori"><span>Data</span> <i class="bi bi-chevron-right"></i></a>
                <ul>
                  <li><a href="ref/dpengguna.php">Pengguna</a></li>
                  <li><a href="ref/dinfo.php">Informasi</a></li>
                  <li><a href="ref/djadwal.php">Jadwal</a></li>
                  <li><a href="ref/dkonten.php">Konten</a></li>
                  </ul>
              </li>
          <li><a class="nav-link scrollto" href="ref/pesan.php">Pemesanan</a></li>
          <li><a class="nav-link scrollto" href="ref/trans.php">Transaksi</a></li>
          <li><a class="nav-link scrollto" href="ref/costumerS.php">Costumer Service</a></li>
          <li><a class="nav-link scrollto" href="ref/laporan.php">Laporan</a></li>
        </ul>
