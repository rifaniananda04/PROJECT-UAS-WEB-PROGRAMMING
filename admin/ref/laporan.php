...
<head>
  ...
  <title>Sepeda Air Danau Kelapa Gading Admin-CSLPRN_page.com</title>
...
<div class="container border border-2 rounded-3 p-2" style="margin-top: 120px;">
    <div class="row m-2">
      ...
      <p  class="text-center"><a href="prn-slprn.php" target="_blank" class="text-primary" >Cetak Seluruh Laporan disini!!</a></p>
    </div>
        <div class="col-md-12">
