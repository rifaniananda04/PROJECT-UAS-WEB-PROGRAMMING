...
$cs  = mysqli_query($koneksi,"SELECT * FROM tbl_costumers");
...
<head>
  ...
  <title>Sepeda Air Danau Kelapa Gading Admin-CS_page.com</title>
        ...
        <?php foreach ($cs as $data ) : ?> 
            <tr>
                ...
                <td class="text-center" >
                    <button class="btn btn-sm btn-danger"><a href="hps-cs.php?id=<?= $data["id"]?>" class="text-light" >Hapus</a></button>
                </td>
            </tr>
        <?php $i++; ?>
        <?php endforeach; ?>
