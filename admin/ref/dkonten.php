...
$k  = mysqli_query($koneksi,"SELECT * FROM tbl_konten");
...
<head>
  ...
  <title>Sepeda Air Danau Kelapa Gading Admin-DK_page.com</title>
...
<div class="container border border-2 rounded-3 p-2" style="margin-top: 120px;">
    <div class="row m-2">
      <div class="col-md-12 mb-3">
        <button class="btn btn-primary mt-2 mb-2" ><a href="tmb-ktn.php" class="text-light" >Tambah Konten Baru</a></button>
      </div>
        <div class="col-md-12">
    ...
    <tbody>
        ...
        <?php foreach ($k as $data ) : ?> 
            <tr>
                ...
                <td><a href="../../assets/img/<?= $data["foto"]?>"><img src="../../assets/img/<?= $data["foto"]?>" alt="kontent.jpg" width="200px"></a></td>
                <td class="d-flex mt-5" >
                    <button class="btn btn-sm btn-warning ms-2 me-2"><a href="ubh-ktn.php?id=<?= $data["id"];?>" class="text-light">Ubah</a></button>
                    <button class="btn btn-sm btn-danger" ><a href="hps-ktn.php?id=<?= $data["id"];?>" class="text-light" onclick="return confirm('Yakin ingin mengahpus user ini ?');">Hapus</a></button>
                </td>
            </tr>
        <?php $i++; ?>
        <?php endforeach; ?>
