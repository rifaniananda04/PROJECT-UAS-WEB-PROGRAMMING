...
<head>
  ...
  <title>Sepeda Air Danau Kelapa Gading</title>
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          ...
          <li class="dropdown"><a href="#kategori"><span>Data</span> <i class="bi bi-chevron-right"></i></a>
                <ul>
                  <li><a href="hal-refrensi/ds-user.php">Pengguna</a></li>
                  <li><a href="hal-refrensi/ds-user.php">Informasi</a></li>
                  <li><a href="hal-refrensi/ds-user.php">Jadwal</a></li>
                  <li><a href="hal-refrensi/ds-user.php">Konten</a></li>
                  </ul>
              </li>
          <li><a class="nav-link scrollto" href="#buy-tickets">Pemesanan</a></li>
          <li><a class="nav-link scrollto" href="#venue">Transaksi</a></li>
          <li><a class="nav-link scrollto" href="#contact">Costumer Service</a></li>
          <li><a class="nav-link scrollto" href="#hotels">Laporan</a></li>
        </ul>
            ...
            <div class="container" data-aos="fade-up">
              ...
              <div class="row">
                ...
                <!-- <div class="col-lg-4" data-aos="fade-up" data-aos-delay="200">
                  <div class="card mb-5 mb-lg-0">
                    <div class="card-body">
                      <h5 class="card-title text-muted text-uppercase text-center">Ticket Wahana Siang</h5>
                      <h6 class="card-price text-center">Rp.20.000</h6>
                      <hr>
                      <ul class="fa-ul">
                        <li><span class="fa-li"><i class="fa fa-check"></i></span>2 Orang</li>
                        <li><span class="fa-li"><i class="fa fa-check"></i></span>1 Jam Permainan</li>
                        <li><span class="fa-li"><i class="fa fa-check"></i></span>Free Keliling Danau</li>
                        <li><span class="fa-li"><i class="fa fa-check"></i></span>Boleh membawa makanan dan minuman</li>
                        <li class="text-muted"><span class="fa-li"><i class="fa fa-times"></i></span>Bebas Pilih Sepeda Air</li>
                      </ul>
                      <hr>
                      <div class="text-center">
                ...
                <!-- <div class="col-lg-4" data-aos="fade-up" data-aos-delay="300">
                  <div class="card">
                    <div class="card-body">
                      <h5 class="card-title text-muted text-uppercase text-center">Ticket Wahana Malam</h5>
                      <h6 class="card-price text-center">Rp.25.000</h6>
                      <hr>
                      <ul class="fa-ul">
                        <li><span class="fa-li"><i class="fa fa-check"></i></span>2 Orang</li>
                        <li><span class="fa-li"><i class="fa fa-check"></i></span>1 Jam Permainan</li>
                    ...
                    <form method="POST" action="#">
                      ...
                      <div class="form-group mt-3">
                        <select id="ticket-type" name="ticket-type" class="form-select">
                          <option value="">-- Pilihan Waktu Bermain --</option>
                          <option value="standard-access">Ticket Wahana Pagi</option>
                          <option value="pro-access">Ticket Wahana Siang</option>
                          <option value="premium-access">Ticket Wahana Malam</option>
                        </select>
                      </div>
